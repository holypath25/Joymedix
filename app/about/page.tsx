...
export const metadata: Metadata = {
  title: 'About Team JOYMEDIX — Korean Medical Beauty Expertise, Delivered Globally',
  description:
    'Team JOYMEDIX connects Korean clinical beauty expertise with clinics in Toronto and Sydney through seminars, beautician placement, and aesthetic product supply.',
}
      ...
      <section className="bg-[#1e3a5f] text-white">
        <div className="container-page py-20 lg:py-24">
          <div className="max-w-2xl">
            <p className="text-sm font-semibold text-[#4db8b8] uppercase tracking-wider mb-3">About Team JOYMEDIX</p>
            ...
            <p className="mt-6 text-lg text-white/70 leading-relaxed">
              Team JOYMEDIX is a three-person platform bridging Korea's clinical beauty expertise with clinics and businesses in Toronto and Sydney — through professional education, workforce placement, and aesthetic product supply.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className={`rounded-2xl border-l-4 ${BUSINESSES[1].color} ${BUSINESSES[1].bg} p-8`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-[#008080] rounded-xl p-5 text-white">
                  <p className="font-semibold mb-3 text-sm">Team JOYMEDIX 매칭 플랫폼</p>
                  <ul className="space-y-2">
